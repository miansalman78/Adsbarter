...
const App: React.FC = () => {
  ...
  const [appNavigatorActiveTab, setAppNavigatorActiveTab] = useState<string>('Home'); // Store AppNavigator's active tab
  ...
  const navigation = {
    ...
    goBack: () => {
      if (screenHistory.length > 0) {
        ...
        // If going back to AppNavigator, restore the preserved tab from current screen params
        if (previousScreen === 'AppNavigator') {
          ...
          // If no preserved tab in params, keep the current stored tab
        }
  ...
  const renderScreen = () => {
    try {
      switch (currentScreen) {
        ...
        case 'AppNavigator':
          // When returning to AppNavigator, use the stored active tab
        ...
        case 'CampaignDetails':
          return <CampaignDetails navigation={navigation} route={{ params: screenParams['CampaignDetails'] }} />;
        case 'CreateCampaign':
          return <CreateCampaign navigation={navigation} route={{ params: screenParams['CreateCampaign'] }} />;
        case 'CreateOffer':
          return (
            <>
              <CreateOffer navigation={navigation} route={{ params: screenParams['CreateOffer'] }} />
              <Drawer
                isOpen={isDrawerOpen}
        ...
        case 'Proposals':
          return <Proposals navigation={navigation} userRole={userRole} />;
        case 'ExploreOffers':
